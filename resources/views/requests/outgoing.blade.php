	...
	<div class="RequestsTable__row">
		...
		<div class="Request__actions">
			...
			<v-form action="{{ url('request/' . $request->request_id) }}" method="post">
				...
				<v-button class="Button Button--danger"><svg class="MyItem__delete-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 438.529 438.529" style="enable-background:new 0 0 438.529 438.529;" xml:space="preserve">
